...
/// Paginated Radarr history: grabs, imports, failures, deletions, renames.
class RadarrHistoryScreen extends ConsumerStatefulWidget {
  const RadarrHistoryScreen({super.key});

  @override
  ConsumerState<RadarrHistoryScreen> createState() =>
      _RadarrHistoryScreenState();
}

class _RadarrHistoryScreenState extends ConsumerState<RadarrHistoryScreen> {
  static const _pageSize = 50;

  final _scrollController = ScrollController();
  List<RadarrHistoryRecord> _records = [];
  int _totalRecords = 0;
  int _page = 1;

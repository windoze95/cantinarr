...
/// Interactive release search for one season of a series.
/// Queries all indexers live (slow), lists releases and lets the admin grab
/// one manually.
class SonarrReleasesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SonarrReleasesScreen> createState() =>
      _SonarrReleasesScreenState();
}

class _SonarrReleasesScreenState extends ConsumerState<SonarrReleasesScreen> {
  ...
  List<SonarrRelease> get _sorted {
  ...
  static int _smartCompare(SonarrRelease a, SonarrRelease b) {
  ...
  Future<void> _confirmGrab(SonarrRelease release) async {

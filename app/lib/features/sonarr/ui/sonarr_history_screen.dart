...
/// Paginated Sonarr history: grabs, imports, failures, deletions, renames.
class SonarrHistoryScreen extends ConsumerStatefulWidget {
  const SonarrHistoryScreen({super.key});

  @override
  ConsumerState<SonarrHistoryScreen> createState() =>
      _SonarrHistoryScreenState();
}

class _SonarrHistoryScreenState extends ConsumerState<SonarrHistoryScreen> {
  static const _pageSize = 50;

  final _scrollController = ScrollController();
  List<SonarrHistoryRecord> _records = [];
  int _totalRecords = 0;
  int _page = 1;

...
5. Under **User Access**, grant the people who should listen. They also need their own Chaptarr access to see the books in Cantinarr. Neither service grants the other; every Audiobookshelf instance requires its own access grant.

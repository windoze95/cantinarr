...
// aiToolDefs is the real 41-tool registry in registration order: mcp/tools.go
// toolDefinitions (browse_titles inlined after get_trending), then the
// arr_tools.go init() appends arrToolDefinitions, arrSettingsToolDefinitions,
// and arrProfileToolDefinitions. Descriptions are verbatim.
var aiToolDefs = []aiToolDef{
	...
	{Name: "browse_titles", Permission: "media:discover", AdminOnly: false,
	...
	{Name: "search_music", Permission: "media:discover", AdminOnly: false,
	...
	{Name: "get_episode_timeline", Permission: "arr:read", AdminOnly: true,
	...
	{Name: "get_media_file_details", Permission: "arr:read", AdminOnly: true,
	...
	{Name: "get_service_config", Permission: "arr:read", AdminOnly: true,
	...
	{Name: "get_book_timeline", Permission: "arr:read", AdminOnly: true,
	...
	{Name: "get_album_timeline", Permission: "arr:read", AdminOnly: true,

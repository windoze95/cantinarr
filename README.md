...
- **Request approvals** -- Optional approval queue, globally or per user. Admins also control per-user season choice, quality choice, and default quality profiles. Requesters can opt into push notifications for approvals and denials.

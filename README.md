...
- **Discord request alerts** -- Send new movie, TV, book, and music requests to one Discord text channel, with an optional choice to include automatically approved requests. Open **Settings > Notifications > Discord Notifications**, paste a webhook URL, and send a sample test. The screen explains the title/requester information shared with Discord and shows delivery results; native push is not required.

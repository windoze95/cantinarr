...
- **Discord request alerts** -- Send new movie, TV, book, and music requests to one Discord text channel, including automatically approved requests. Enable **Settings > Discord Notifications**, paste a webhook URL, and send a sample test. The screen explains the title/requester information shared with Discord and shows delivery results; native push is not required.

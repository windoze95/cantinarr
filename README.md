...
- **Requests survive outages** -- Movie, TV, book, and album requests save before delivery and retry temporary failures after a restart. Approval and delivery progress stay separate; each book format has its own progress. Match an uncertain book on its detail page, retry a request that needs attention, or cancel it without discarding other people's shared requests.

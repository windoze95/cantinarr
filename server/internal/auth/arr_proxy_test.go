...
func TestIsArrReadPath(t *testing.T) {
	tests := []struct {
		...
		{"chaptarr author lookup", "chaptarr", "api/v1/author/lookup", true},
		...
		{"chaptarr author lookup subroute", "chaptarr", "api/v1/author/lookup/1", false},
		{"chaptarr author editor subroute", "chaptarr", "api/v1/author/editor", false},
		{"sonarr author lookup rejected", "sonarr", "api/v3/author/lookup", false},
...
func TestRequireArrProxyAccess_ServiceBoundary(t *testing.T) {
	tests := []struct {
		...
		{"deluge rejects arr-shaped path", "deluge", true, nil, "/api/instances/abc/api/v3/movie", http.StatusForbidden},
		{"rutorrent rejects arr-shaped path", "rutorrent", true, nil, "/api/instances/abc/api/v3/movie", http.StatusForbidden},

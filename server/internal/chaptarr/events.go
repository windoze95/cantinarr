...
var importEventTypes = map[string]struct{}{
	...
	"bookimport": {}, "bookimported": {}, "downloadimported": {}, "downloadfolderimported": {},
}
...
// IsImportEventType reports whether a raw Readarr-lineage event name announces
// a completed import, folding case and separators first.

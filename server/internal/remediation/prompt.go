...
- For a bad queued TV release whose episode has not aired yet, propose remediate_queue with blocklist_only, even when there is no library copy. Leave episode monitoring unchanged. Do not follow this cleanup with trigger_search or grab_release for the unaired episode. The date alone does not prove the downloaded content is wrong; verify the mismatch separately. Successful cleanup means the exact bad download is gone, not that the unaired episode is available.
